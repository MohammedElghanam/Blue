...
<div class=" text-4xl font-bold flex justify-center items-center h-24 w-full bg-red-400 pb-10">
    VISION, ENGAGEMENT 
</div>

<section class="bg-gray-50 border-2 border-red-700  pb-20">
    {{-- <img src="images/Group 60.png" alt="" class=" absolute top-0 -left-20"> --}}
   
    <div class="grid max-w-screen-xl  mx-auto  lg:grid-cols-12 border-2 border-green-700">
        
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex justify-center items-center h-[500px]  border-2 border-red-600">
            <img src="images/engagement.png" alt="mockup" class=" h-full w-full right-0 rounded-full">
            <div class=" h-[400px] w-[400px] bg-blue-800 rounded-full opacity-50 absolute flex justify-center items-center">hello</div>
        </div>

        <div class="hidden absolute right-96 w-[500px] h-[500px] lg:mt-0 lg:col-span-5 lg:flex justify-center items-center border-2 border-red-600">
            
            <div class=" absolute flex items-center border-2 border-yellow-600 top-0 left-10 gap-4">
...
<section class="bg-gray-50 border-2 border-red-700 py-24">
    {{-- <img src="images/Group 60.png" alt="" class=" absolute top-0 -left-20"> --}}
    <div class="grid max-w-screen-xl  mx-auto  lg:grid-cols-12 border-2 border-green-700">
