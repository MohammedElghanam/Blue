...
<section class="bg-gray-50 border-2 border-green-600">
    <div
        class="grid max-w-screen-xl px-4 mx-auto  lg:grid-cols-2 border-2 border-cyan-600">
        <div class=" col-span-2 border-2 border-green-500 mb-4 h-12 flex justify-center items-center">
            hello
        </div>
        <div class="relative w-full col-span-2 h-20 overflow-hidden border-2 border-yellow-600">
