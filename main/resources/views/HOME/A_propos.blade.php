...
<section class="bg-gray-50">
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex justify-center items-center h-full border-2 border-red-400">
    ...
    <div class=" grid grid-cols-4 border-2 border-red-600 absolute w-1/3 left-72 bottom-72">
